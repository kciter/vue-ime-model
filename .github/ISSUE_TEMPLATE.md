...
- Read the docs: https://github.com/kciter/v-ime-model/blob/dev/README.md
- Ask in the Gitter chat room: https://gitter.im/vuejs/vue
- Ask on the forums: http://forum.vuejs.org/
- Look for/ask questions on stack overflow: https://stackoverflow.com/questions/ask?tags=v-ime-model
